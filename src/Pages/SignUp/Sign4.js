...
const Sign2 = () => {
  const [knowvalue, setKnowvalue] = useState();
  ...
  return (
    <div className="md:w-6/12 w-11/12 md:my-20 my-20 pt-5 rounded-xl bg-white mx-auto">
      ...
      <p className="my-8">
        This is the one you use to enter the UK for your temporary employment.
      </p>
      <ul class="grid w-full gap-6 md:grid-cols-2">
    <li>
        <input onClick={() => nave("/signup/14")} type="radio" id="hosting-small" name="hosting" value="hosting-small" class="hidden peer" />
